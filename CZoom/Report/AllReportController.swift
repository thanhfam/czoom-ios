...
class AllReportController: MyViewController, UITableViewDataSource, UITableViewDelegate {
	...
	override func viewDidLoad() {
		...
		self.navigationItem.title = LocalizedString("All reports")
	...
	func loadReportList() -> Void {
		...
		self.sessionManager
			.request(URL_REPORT_ALL, method: .get)
			.responseJSON {
				response in
